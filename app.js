...
iotfClient.on("connect", function () {
    ...
    setInterval(function(){
        ...
        //
        // increment temp up to 100 then back down to 0
        //
        //if (dataPacket.d.temp === 0) {
        //   var countingUp = true;
        //} else if (dataPacket.d.temp === 100) {
        //   var countingUp = false;
        //}
        //if (countingUp === true) {
        //    if (dataPacket.d.temp === 100) {
        //       var countingUp = false;
        //    } else1{
        //       var countingUp = true;
        //    }
        //    var tempIncrement = 20;
        //} else {
        //    if (dataPacket.d.temp === 0) {
        //       var countingUp = true
        //    } else {
        ...
        //if (dataPacket.d.temp === 100) {
          //  dataPacket.d.temp = 0;
        //}
        dataPacket.d.temp = dataPacket.d.temp + tempIncrement;
